	...
	return (
        ...
        <section className="hero">
            <div className="container hero-container">
                ...
                <div className="right">
                    <img src="src/images/hero.svg" alt="Hero image" />
                </div>
            </div>
        </section>
            ...
            <div className="container">
                ...
                <div className="services-list">
                    <div className="service-item">
                        <img src="src/images/services/service1.png" alt=""	/>
                        <h3>Web Design</h3>
                        <p>Nulla vitae elit libero, a pharetra augue. Donec id elit non mi porta gravida at eget. Fusce dapibus tellus.</p>
                        <a href="">Learn More</a>
                    </div>
                    <div className="service-item">
                        <img src="src/images/services/service2.png" alt=""	/>
                        <h3>Web Design</h3>
                        <p>Nulla vitae elit libero, a pharetra augue. Donec id elit non mi porta gravida at eget. Fusce dapibus tellus.</p>
                        <a href="">Learn More</a>
                    </div>
                    <div className="service-item">
                        <img src="src/images/services/service3.png" alt=""	/>
                        <h3>Web Design</h3>
                        <p>Nulla vitae elit libero, a pharetra augue. Donec id elit non mi porta gravida at eget. Fusce dapibus tellus.</p>
                        <a href="">Learn More</a>
                    </div> 
        ...
        <section className="team">
            <div className="container team-container">
                ...
                <div className="team-statistics">
                    ...
                    <div className="team-statistics-item">
                        <div className="image">
                            <img src="src/images/icons/user.svg" alt="" />
                        </div>
                        <h3>50k</h3>
                        <p>Happy customers</p>
                    </div>
                    <div className="team-statistics-item">
                        <div className="image">
                            <img src="src/images/icons/trophy.svg" alt=""	/>
                        </div>
                        <h3>20k</h3>
                        <p>Awards won</p>
                    </div>
                ...
                <div className="team-list">
                    <div className="team-item">
                        <img src="src/images/team/te4.jpg" alt="" />
                        <h3>Coriss Ambady</h3>
        ...
        <section className="projects">
            ...
            <div className="container projects-container">
            	 <div className="project">
                    <img src="src/images/projects/project1.jpg" alt="" />
                    <h3>nombre del proyecto</h3>
                    <p>categoria</p>
                </div>
                <div className="project">
                    <img src="src/images/projects/project2.jpg" alt="" />
                    <h3>nombre del proyecto</h3>
                    <p>categoria</p>
                </div> 
                {/* <div className="project">
                    <img src="src/images/projects/project3.jpg" alt="" />
                    <h3>nombre del proyecto</h3>
                    <p>categoria</p>
                </div> */}
            </div>
                ...
                <div className="testimonials-list">
                    <div className="testimonials-item">
                        ...
                        <div className="testimonials-author">
                            <div className="image">
                                <img src="src/images/team/te1.jpg" alt="" />
                            </div>
                            <div className="bio">
                                <h3>Coriss Ambady</h3>
                                <p>Financial Analyst</p>
